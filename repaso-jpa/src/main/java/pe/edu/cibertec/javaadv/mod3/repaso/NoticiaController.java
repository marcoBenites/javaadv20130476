...
public class NoticiaController implements Serializable {
    ...
    @EJB private pe.edu.cibertec.javaadv.mod3.repaso.NoticiaFacade ejbFacade;
    ...
    public static class NoticiaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Noticia) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+Noticia.class.getName());
            }
        }
